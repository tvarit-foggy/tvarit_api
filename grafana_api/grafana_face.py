...
from .api import (Admin, Dashboard, Datasource, Folder, Organization,
                  Organizations, Search, User, Users, Teams, Pipeline, Handler,
                  Model, DashboardVersion, Alerting, Annotations, Snapshot)
...
class GrafanaFace:
    def __init__(self, auth, host="localhost", port=None, url_path_prefix="", protocol="http", verify=True):
        ...
        self.dashboard_version = DashboardVersion(self.api)
