...
class TestTvaritAPI(unittest.TestCase):
    @patch('tvarit_api.tvarit_api.TvaritAPI.__getattr__')
  ...
  "isTvaritAdmin": true
        ...
        cli = TvaritFace(('admin', 'admin'), host='localhost',
    ...
    def test_tvarit_api_token_auth(self):
        cli = TvaritFace('alongtoken012345etc', host='localhost',
                         url_path_prefix='', protocol='https')
